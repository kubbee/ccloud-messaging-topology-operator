...
import (
	...
	"github.com/kubbee/ccloud-messaging-topology-operator/controllers"
...
func init() {
	...
	utilruntime.Must(messagesv1alpha1.AddToScheme(scheme))
...
func main() {
	...
	mgr, err := ctrl.NewManager(ctrl.GetConfigOrDie(), ctrl.Options{
		...
		LeaderElectionID:       "1fd723ab.kubbee.tech",
	})
	if err != nil {
	...
	if err = (&controllers.KafkaReferenceReconciler{
		Client: mgr.GetClient(),
		Scheme: mgr.GetScheme(),
	}).SetupWithManager(mgr); err != nil {
		setupLog.Error(err, "unable to create controller", "controller", "KafkaReference")
		os.Exit(1)
	}
